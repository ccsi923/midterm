...
class CheckingControllerImplTest {
    ...
    void setUp() {
        ...
        AccountUser accountUser3 = new AccountUser("cristian", passwordEncoder.encode("cristian"));
        ...
        AccountUser accountUser4 = new AccountUser("elisa", passwordEncoder.encode("elisa"));
    ...
    void findAll() throws Exception {
        MvcResult result =   mockMvc.perform(get("/checkings")
    ...
    void create() throws Exception {
        ...
        PasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
        AccountUser accountUser = new AccountUser("andrea", passwordEncoder.encode("andrea"));
        ...
        AccountUser accountUser2 = new AccountUser("koko", passwordEncoder.encode("koko"));
        AccountHolder accountHolder2 = new AccountHolder(
                "Pepe", LocalDate.of(1989, 11, 12),
                new Address("Madrid", "España", "Higueras 55", "28007"));
        accountUser2.setAccountHolder(accountHolder2);
    ...
    void create_givenIdByParam() throws Exception {
        ...
        mockMvc.perform(post("/checking/?primary="+accountHolders.get(0).getId()+"&secondary="+accountHolders.get(1).getId())
                .with(user("admin").roles("ADMIN"))
                .content(objectMapper.writeValueAsString(accountRequest))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isCreated());
    ...
    void create_BadRequest() throws Exception {
        ...
        AccountRequest accountRequest = new AccountRequest();
        accountRequest.setAmount(new BigDecimal("1000"));
        mockMvc.perform(post("/checking/?primary=1000&secondary=10000")
                .with(user("admin").roles("ADMIN"))
                .content(objectMapper.writeValueAsString(accountRequest))
                .contentType(MediaType.APPLICATION_JSON))
    ...
    void create_student() throws Exception {
        ...
        PasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
        AccountUser accountUser = new AccountUser("pepes", passwordEncoder.encode("pepe"));
        ...
        AccountUser accountUser2 = new AccountUser("anasegarra", passwordEncoder.encode("ana"));
        AccountHolder accountHolder2 = new AccountHolder(
                "Pepe", LocalDate.of(1999, 11, 12),
                new Address("Madrid", "España", "Higueras 55", "28007"));
        accountUser2.setAccountHolder(accountHolder2);
    ...
    @Test
    void create_Student_givenIdByParam() throws Exception {
        List<AccountHolder> accountHolders = accountHolderRepository.findAll();
        ...
        mockMvc.perform(post("/checking/?primary="+accountHolders.get(2).getId()+"&secondary="+accountHolders.get(3).getId())
                .with(user("admin").roles("ADMIN"))
                .content(objectMapper.writeValueAsString(accountRequest))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isCreated());
